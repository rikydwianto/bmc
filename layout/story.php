<div id="story">
        <!-- Section 2: Story 1 -->
        <section id="story1" style="
          background: url('assets/img/bg-story1.png') no-repeat center center;
          background-size: cover;
        ">
            <div class="container-fluid story-section py-5 fade-in-down">
                <div class="row justify-content-center align-items-center">
                    <div class="col-md-5 text-center">
                        ...
                        <img src="assets/img/the-flory.png" alt="Paris Footprint" title="Paris Journey"
                            class="story-image mb-4 mb-md-0" />
                    </div>
                    <div class="col-lg-6 p-3">
                        ...
                        <p>
                            ...
                            <b>Paris sur la terre—Paris sur cette terre, un véritable
                                miracle.</b>
                        </p>
                        <h5 class="subsection-title mt-3">
        ...
        <!-- <hr class="my-5" style="border: none; height: 2px; background: linear-gradient(to right, transparent, #ccc, transparent);"> -->

        <!-- Section 3: Story 2 -->
        <section id="story2" style="
          background: url('assets/img/bg-story2.png') no-repeat center center;
          background-size: cover;
        ">
            <div class="container-fluid story-section py-5 fade-in-down">
                <div class="row justify-content-center align-items-center flex-md-row-reverse">
                    <div class="col-md-5 text-center">
                        ...
                        <img src="assets/img/story2.png" alt="Story 2" class="story-image mb-4 mb-md-0" />
                    </div>
                    <div class="col-lg-6 story-text p-3">
                        <h5 class="subsection-title">UN “BONJOUR” EN ATTENTE</h5>
                        <p>
                        ...
                        <h5 class="subsection-title mt-3">A WAITING “HELLO”</h5>
                        <p>
        ...
        ">
            <div class="container-fluid story-section py-5 fade-in-down">
                <div class="row justify-content-center align-items-center">
                    <!-- Gambar kiri -->
                    <div class="col-md-5 text-center mt-3 mb-3">
                        <div class="logo-container mx-auto">
                            <div class="dots">
                                <div class="dot"></div>
                                <div class="dot"></div>
                        ...
                        <img src="assets/img/story3.png" alt="Story 2" class="story-image mb-4 mb-md-0" />
                    </div>

                    <!-- Teks kanan -->
                    <div class="col-lg-6 story-text p-3">
                        <h5 class="subsection-title">La Lumière du Dimanche à Paris</h5>
                        <p>
                        ...
                        <h5 class="subsection-title mt-3">The Sunday Light in Paris</h5>
                        <p>
        ...
        <section id="story4" style="
          background: url('assets/img/story4.png') no-repeat center center;
          background-size: cover;
        ">
            <div class="container-fluid story-section py-5 fade-in-down">
                <div class="row justify-content-center align-items-center">
                    ...
                    <div class="col-md-5 text-center mt-3 mb-3">
                        ...
                        <img src="assets/img/story4.png" alt="Story 2" class="story-image mb-4 mb-md-0" />
                    </div>
        ...
        <section id="story5" style="
          background: url('assets/img/bg-story4.png') no-repeat center center;
          background-size: cover;
        ">
            <div class="container-fluid story-section py-5 fade-in-down">
                <div class="row justify-content-center align-items-center flex-md-row-reverse">
                    ...
                    <div class="col-md-5 text-center mt-3 mb-3">
                        ...
                        <div class="frame-wrapper position-relative d-inline-block"
                            style="max-width: 100%; animation: slideDownFade 1s ease-out;">
                            <img src="assets/img/story5.png" alt="Frame" class="img-fluid"
                                style="position: relative; z-index: 2;" />
                            <img src="assets/img/paris5.jpg" alt="Une Nuit Gardée dans un Cadre Doréss"
                                class="img-fluid position-absolute top-50 start-50 translate-middle"
                                style="width: 95%; z-index: 1;" />
                        </div>
                    </div>
        ...
        <section id="story6" style="
          background: url('assets/img/bg-story6.png') no-repeat center center;
          background-size:cover;
        ">
            <div class="container-fluid story-section py-5 fade-in-down">
                <div class="row justify-content-center align-items-center flex-md-row-reverse">
                    ...
                    <div class="col-md-5 text-center mt-3 mb-3">
                        ...
                        <img src="assets/img/story6.png" alt="Story 6"
                            class="story-image mb-4 mb-md-0 animated-story" />
        ...
        <section id="story7 " style="
          background: url('assets/img/bg-story7.png') no-repeat center center;
          background-size:cover;
        ">
            <div class="container-fluid story-section py-5 fade-in-down">
                <div class="row justify-content-center align-items-center flex-md-row-reverse">
                    ...
                    <div class="col-md-5 text-center mt-3 mb-3">
                        ...
                        <div class="frame-wrapper position-relative d-inline-block"
                            style="max-width: 100%; animation: slideDownFade 1s ease-out;">
                            <img src="assets/img/story7.png" alt="Frame" class="img-fluid"
                                style="position: relative; z-index: 2;" />
                            <img src="assets/img/carpe-diem.png" alt="Carpe Diem"
                                class="img-fluid position-absolute top-50 start-50 translate-middle"
                    ...
                    <!-- Teks kanan -->
                    <div class="col-lg-6 story-text p-3">
                        <h5 class="subsection-title fade-in-downs">
        ...
        <section id="story8" style="
  background: url('assets/img/bg-story8.png') no-repeat center center;
  background-size: cover;
">
            <div class="container-fluid story-section py-5 fade-in-down">
                <div class="row justify-content-center align-items-stretch">
                    ...
                    <!-- Gambar kiri -->
                    <div class="col-md-4 d-flex align-items-center justify-content-center fade-in-down">
                        <div
                            class="frame-wrapper position-relative w-100 h-100 d-flex align-items-center justify-content-center">
                            <img src="assets/img/story8.png" alt="Frame" class="img-fluid position-relative z-2"
                                style="max-height: 100%; max-width: 100%;" />
                            <img src="assets/img/soul-free.png" alt="Soul Free"
                                class="img-fluid position-absolute top-50 start-50 translate-middle"
                                style="width: 80%; z-index: 1;" />
                        </div>
                    </div>
                    ...
                    <!-- Teks kanan -->
                    <div class="col-lg-7 story-text p-3 fade-in-down">
                        <h5 class="subsection-title">L'Essence d'un Parfum – Philosophie et Inspiration dans la Culture
                            Française</h5>
                        <p>Le parfum n’est pas qu’une simple fragrance. C’est un souvenir enfermé dans une bouteille de
                        ...
                        <h5 class="subsection-title mt-3">The Essence of a Scent – Philosophy and Inspiration in French
                            Culture</h5>
                        <p>Perfume is not just a fragrance. It is a memory locked inside a glass bottle, waiting to be
        ...
        <section id="story9" style="background: url('assets/img/bg-story9.png') no-repeat center center;
  background-size: cover;
">
            <div class="container-fluid story-section py-5 fade-in-down">
                <div class="row justify-content-center align-items-stretch">
                    ...
                    <!-- Teks kiri -->
                    <div class="col-lg-7 story-text p-3 fade-in-down">
                        <h5 class="subsection-title">"Ma Joie de Vivre" – Philosophie du Bonheur sous la Pluie</h5>
                        <p>
                        ...
                        <h5 class="subsection-title">"Ma Joie de Vivre" – The Philosophy of Happiness in the Rain</h5>
                        <p>
                    ...
                    <div class="col-md-4 d-flex align-items-center justify-content-center fade-in-down">
                        <div
                            ...
                            <!-- Frame utama -->
                            <img src="assets/img/story9.png" alt="Frame" class="img-fluid position-relative z-2"
                                style="max-height: 100%; max-width: 100%;" />

                            <!-- Gambar sub (ditumpuk di tengah frame) -->
                            <img src="assets/img/story9-sub.png" alt="Story 9 Sub"
                                class="img-fluid position-absolute  start-50 translate-middle"
                                style="width: 70%; z-index: 3;top:80%" />
        ...
        <section id="story10" style="
  background: url('assets/img/bg-story10.png') no-repeat center center;
  background-size: cover;
  width: 100%;
  min-height: 100vh;
  display: flex;
...
">
            ...
            <div
                style="position: absolute; top: 0; left: 0; right: 0; bottom: 0; background: rgba(0, 0, 0, 0.5); z-index: 1;">
            </div>

            <div class="container-fluid story-section py-5 fade-in-down" style="position: relative; z-index: 2;">
                <div class="row justify-content-center align-items-stretch">
                    ...
                    <div class="col-md-4 d-flex align-items-center justify-content-center fade-in-down">
                        <div
                            ...
                            <!-- Frame utama -->
                            <img src="assets/img/story10.png" alt="Frame" class="img-fluid position-relative z-2"
                                style="max-height: 100%; max-width: 100%;" />

                            <!-- '3 gambar tanpa jarak di dalam frame, dengan sedikit margin antar gambar -->
                            <div class="position-absolute top-50 start-50 translate-middle d-flex"
                                style="width: 100%; z-index: 3;">
                                <img src="assets/img/story10-1.png" alt="Sub 1" class="img-fluid"
                                    style="width: 33%; margin-right: 10px;" />
                                <img src="assets/img/story10-2.png" alt="Sub 2" class="img-fluid"
                                    style="width: 33%; margin-right: 10px;" />
                                <img src="assets/img/story10-3.png" alt="Sub 3" class="img-fluid" style="width: 33%;" />
                            </div>
                    ...
                    <!-- Teks kanan -->
                    <div class="col-lg-7 story-text p-3 fade-in-down">
                        <h5 class="subsection-title">"Reflets d’Émotions" – Les Instants Figés dans le Temps</h5>
                        <p>
