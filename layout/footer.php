 ...
 <footer class="text-light pt-5 pb-4" id="contact" style="background-color: #1a1a1a">
     <div class="container">
         <div class="row justify-content-between align-items-center text-center text-md-start">
             <!-- Logo Kiri -->
             <div class="col-lg-4 mb-4 ms-5 mb-lg-0">
                 <a href="index.php"
                     class="d-flex align-items-center justify-content-center justify-content-lg-start text-decoration-none text-white logo-link">
             ...
             <div class="col-lg-4 text-center text-lg-end">
                 <div class="mb-2">
                     ...
                     <a href="https://wa.me/6287860322676" target="_blank" class="text-light text-decoration-none me-3">
                 ...
                 <!-- <small class="d-block mt-2">Jl. Mawar No.123, Jakarta</small> -->
                 <small class="d-block">Telp: +62 878-6032-2676</small>
             </div>
         </div>
